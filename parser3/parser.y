...
statement
    ...
    |
    if_statement {struct CodeNode * node = new CodeNode; $$ = node;}
    |
    read_statement SEMICOLON {struct CodeNode * node = new CodeNode; $$ = node;}
    |
    while_statement {struct CodeNode * node = new CodeNode; $$ = node;}
    |
...
function_decleration
    : FUNC IDENTIFIER L_PAR {symbolTable.clear();}paramerter_decleration R_PAR L_CURLY statements R_CURLY 
    {
        std::string subS = "";
        int cnt = 0;
        int dotPlace = 0;
