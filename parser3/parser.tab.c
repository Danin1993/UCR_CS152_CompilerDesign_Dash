...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_bool_expression = 52,           /* bool_expression  */
  ...
  YYSYMBOL_read_statement = 58,            /* read_statement  */
...
static const char *const yytname[] =
{
  ...
  "$@1", "var_assigment", "expression", "bool_expression",
  "multiplicative_expr", "term", "pars", "varibles", "print_statement",
  "read_statement", "while_statement", YY_NULLPTR
};
